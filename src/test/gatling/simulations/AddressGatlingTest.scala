...
class AddressGatlingTest extends Simulation {
    ...
    val authorization_header = "Basic " + Base64.getEncoder.encodeToString("oauthapp:my-secret-token-to-change-in-production".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Address entity")
        ...
        .repeat(2) {
            ...
            .post("/api/addresses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "street":"SAMPLE_TEXT", "number":"SAMPLE_TEXT", "complement":"SAMPLE_TEXT", "country":"SAMPLE_TEXT", "city":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
